...
namespace MundialApiPet.Migrations
{
    ...
    [Migration("20241011222556_11_octubre_2024_tabla_registraventaDos")]
    partial class _11_octubre_2024_tabla_registraventaDos
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MundialApiPet.Modelo.ProductosServicios.DocumentoAdjuntoArticulo", b =>
                {
                    b.Property<int>("IdDocumentoAdjuntoArticulo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INT")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("IdDocumentoAdjuntoArticulo");

                    b.HasIndex("IdArticulo");

                    b.ToTable("DocumentoAdjuntoArticuloTH");
                });

            modelBuilder.Entity("MundialApiPet.Modelo.Ventas.IngresaVentaTH", b =>
                {
                    b.Property<int>("IdIngresaVenta")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INT")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("IdIngresaVenta");

                    b.HasIndex("IdArticulo");

                    b.ToTable("IngresaVenta");
                });
            ...
            modelBuilder.Entity("MundialApiPet.Modelo.ProductosServicios.DocumentoAdjuntoArticulo", b =>
                {
                    b.HasOne("MundialApiPet.Modelo.Inventario.ArticuloInventario", "FK_DocumentoAdjuntoArticuloConArticuloInventario")
                        .WithMany()
                        .HasForeignKey("IdArticulo");
                });
            ...
            modelBuilder.Entity("MundialApiPet.Modelo.Ventas.IngresaVentaTH", b =>
                {
                    b.HasOne("MundialApiPet.Modelo.Inventario.ArticuloInventario", "FK_ArticuloInventarioConIngresaVenta")
                        .WithMany()
                        .HasForeignKey("IdArticulo");
                });
