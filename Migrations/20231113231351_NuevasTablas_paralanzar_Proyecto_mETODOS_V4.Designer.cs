...
namespace MundialApiPet.Migrations
{
    ...
    [Migration("20231113231351_NuevasTablas_paralanzar_Proyecto_mETODOS_V4")]
    partial class NuevasTablas_paralanzar_Proyecto_mETODOS_V4
    {
            ...
            modelBuilder.Entity("MundialApiPet.Modelo.Inventario.TipoRazaInventario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdTipoRazaInventario = 100,
                            Codigo = "COD_DOBERMAN_01",
                            EstadoActivo = true,
                            Nombre = "DOBERMAN"
                        },
                        new
                        {
                            IdTipoRazaInventario = 101,
                            Codigo = "COD_PITBULL_02",
                            EstadoActivo = true,
                            Nombre = "PITBULL"
                        });
                });
